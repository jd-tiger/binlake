...
import com.jd.binlog.dbsync.event.mariadb.AnnotateRowsEvent;
    ...
    public static LogEvent decode(LogBuffer buffer, LogHeader header, LogContext context) throws IOException {
        ...
        switch (header.getType()) {
            case LogEvent.QUERY_EVENT: {
                header.setGtid(context.getGtid());
            ...
            case LogEvent.ROTATE_EVENT: {
                ...
                /* updating position in context */
                logPosition = new LogPosition(event.getFilename(), event.getPosition(), event.getWhen(), false);
            ...
            case LogEvent.ANONYMOUS_GTID_LOG_EVENT: {
                ...
                context.setGtid(event.getSid() + ":" + event.getGtidGNO());
                /* updating position in context */
                logPosition.position = header.getLogPos();
                return event;
            }
