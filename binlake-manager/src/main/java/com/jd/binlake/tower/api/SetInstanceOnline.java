 ...
 */
public class SetInstanceOnline extends AbstractHandler {
    private static final Logger logger = Logger.getLogger(SetInstanceOnline.class);

    private static final String SET_ONLINE = "/set/online";

    public static void register() {
        ApiCenter.register(SET_ONLINE, new SetInstanceOnline());
    }
    ...
    public void handle(String s, Request request, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws IOException, ServletException {
        ...
        try {
            ...
            logger.error("set instance online error: " + ExceptionUtils.getStackTrace(e));
            ApiCenter.write(request, httpServletResponse,
